...
struct BST {
		...
		//Sub-functions
		void deepestNodesHelper(BTNode*);
		void display2(int, ostream&);
		void ascendingOrderPrint(BTNode*,ostream&);
		void descendingOrderPrint(BTNode*, ostream&);
		void EmptyList();
		void FindItem(type, BTNode*, bool&);
		void Clone1(BST, type, BTNode*);
		void Clone2(BST, type, BTNode*);
		void printLevel(BTNode*,int[][10], int);
		void paths(BTNode*,int[]);
		void removeLastNode(int[]);
